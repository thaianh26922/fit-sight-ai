...
const Home: React.FC = () => {
  ...
  //     try {
  //       const response = await fetch('https://ab3d-42-114-171-67.ngrok-free.app/auth/profile', {
  //         headers: {
  ...
  useEffect(() => {
    const fetchHistory = async () => {
      ...
      const token = Cookies.get('accessToken');
      try {
        const response = await fetch('https://ab3d-42-114-171-67.ngrok-free.app/chat/history', {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
  ...
  const handleChat = async (text: string, images: UploadFile[]) => {
    ...
    const token = Cookies.get('accessToken');
    try {
      const response = await fetch('https://ab3d-42-114-171-67.ngrok-free.app/chat/normal', {
        method: 'POST',
        headers: {
  ...
  const handleAnalyzeSubmit = async (info: {
    ...
    const token = Cookies.get('accessToken');
    try {
      const response = await fetch('https://ab3d-42-114-171-67.ngrok-free.app/chat/analyze', {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${token}`,
        },
